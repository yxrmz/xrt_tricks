...
def build_beamline(E):
    ...
    P23_U32.pfl1 = roes.ParaboloidFlatLens(
        ...
        #center=[0, 87894-load_pos-1000 + 0*(2*zmax+t), 0],
        material=lens_Be,
        focus=0.025,
        zmax=zmax,
        t=t,
    ...
    P23_U32.fpl1 = roes.FlatParaboloidLens(
        ...
        center=[0, 87894-load_pos-1000 + 0*(2*zmax+t)+t/2, 0],
        material=lens_Be,
        focus=0.025,
        zmax=zmax,
        t=t,
    ...
    P23_U32.pfl2 = roes.ParaboloidFlatLens(
        ...
        #center=[0, 87894-load_pos-1000 + 1*(2*zmax+t), 0],
        material=lens_Be,
        focus=0.025,
        zmax=zmax,
        t=t,
    ...
    P23_U32.fpl2 = roes.FlatParaboloidLens(
        ...
        #center=[0, 87894-load_pos-1000 + 1*(2*zmax+t)+t/2, 0],
        material=lens_Be,
        focus=0.025,
        zmax=zmax,
        t=t,
    ...
    P23_U32.pfl3 = roes.ParaboloidFlatLens(
        ...
        #center=[0, 87894-load_pos-1000 + 2*(2*zmax+t), 0],
        material=lens_Be,
        focus=0.025,
        zmax=zmax,
        t=t,
    ...
    P23_U32.fpl3 = roes.FlatParaboloidLens(
        ...
        #center=[0, 87894-load_pos-1000 + 2*(2*zmax+t)+t/2, 0],
        material=lens_Be,
        focus=0.025,
        zmax=zmax,
        t=t,
    ...
    P23_U32.pfl4 = roes.ParaboloidFlatLens(
        ...
        #center=[0, 87894-load_pos-1000 + 3*(2*zmax+t), 0],
        material=lens_Be,
        focus=0.025,
        zmax=zmax,
        t=t,
    ...
    P23_U32.fpl4 = roes.FlatParaboloidLens(
        ...
        #center=[0, 87894-load_pos-1000 + 3*(2*zmax+t)+t/2, 0],
        material=lens_Be,
        focus=0.025,
        zmax=zmax,
        t=t,
    ...
    P23_U32.pfl5 = roes.ParaboloidFlatLens(
        bl=P23_U32,
        center=[0, 87894-load_pos-1000+1*(zmax+t), 0],
        #center=[0, 87894-load_pos-1000 + 4*(2*zmax+t), 0],
        material=lens_Be,
        focus=0.025,
        zmax=zmax,
        t=t,
    ...
    P23_U32.fpl5 = roes.FlatParaboloidLens(
        bl=P23_U32,
        center=[0, 87894-load_pos-1000+1*(zmax+t)+t, 0],
        #center=[0, 87894-load_pos-1000 + 4*(2*zmax+t)+t/2, 0],
        material=lens_Be,
        focus=0.025,
        zmax=zmax,
        t=t,
    ...
    P23_U32.pfl6 = roes.ParaboloidFlatLens(
        bl=P23_U32,
        center=[0, 87894-load_pos-1000+3*(zmax+t), 0],
        #center=[0, 87894-load_pos-1000 + 5*(2*zmax+t), 0],
        material=lens_Be,
        focus=0.025,
        zmax=zmax,
        t=t,
    ...
    P23_U32.fpl6 = roes.FlatParaboloidLens(
        bl=P23_U32,
        center=[0, 87894-load_pos-1000+3*(zmax+t)+t, 0],
        #center=[0, 87894-load_pos-1000 + 5*(2*zmax+t)+t/2, 0],
        material=lens_Be,
        focus=0.025,
        zmax=zmax,
        t=t,
    ...
    P23_U32.pfl7 = roes.ParaboloidFlatLens(
        bl=P23_U32,
        center=[0, 87894-load_pos-1000+5*(zmax+t), 0],
        #center=[0, 87894-load_pos-1000 + 6*(2*zmax+t), 0],
        material=lens_Be,
        focus=0.025,
        zmax=zmax,
        t=t,
    ...
    P23_U32.fpl7 = roes.FlatParaboloidLens(
        bl=P23_U32,
        center=[0, 87894-load_pos-1000+5*(zmax+t)+t, 0],
        #center=[0, 87894-load_pos-1000 + 6*(2*zmax+t)+t/2, 0],
        material=lens_Be,
        focus=0.025,
        zmax=zmax,
        t=t,
    ...
    for oenr in range(7):
        for oebasename in ['pfl', 'fpl']:
            oename = oebasename + str(oenr+1)
            print(oename, "y pos:", getattr(P23_U32, oename).center[1])
