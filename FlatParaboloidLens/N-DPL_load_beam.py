...
def build_beamline(E):
    ...
    if showIn3D:
        P23_U32.source = rsources.GeometricSource(
            ...
            dx=0.5, dz=0.5, distxprime=None, distzprime=None, 
            energies=(E*1e3,))

    P23_U32.crl_2 = roes.DoubleParaboloidLens(
        bl=P23_U32,
        name=None,
        center=[0, 87894-load_pos-1000, 0],
        material=lens_Be,
        focus=0.025,
        zmax=zmax,
        t=t,
...
def run_process(P23_U32):
    ...
    doubleParaboloidLens01beamGlobal02, doubleParaboloidLens01beamLocal102, doubleParaboloidLens01beamLocal202 = P23_U32.crl_2.multiple_refract(
        beam=loaded_beam)

    screen02beamLocal01 = P23_U32.screen_sample.expose(
        beam=doubleParaboloidLens01beamGlobal02)

    outDict = {
        'loaded_beam': loaded_beam,
        'doubleParaboloidLens01beamGlobal02': doubleParaboloidLens01beamGlobal02,
        'doubleParaboloidLens01beamLocal102': doubleParaboloidLens01beamLocal102,
        'doubleParaboloidLens01beamLocal202': doubleParaboloidLens01beamLocal202,
...
def define_plots(E):
    ...
    plot_sample = xrtplot.XYCPlot(
        ...
        caxis=xrtplot.XYCAxis(
            ...
            unit=r"eV"),
        aspect=r"auto",
        title=r"N-DPL_%02dkeV.png"%E,
        fluxFormatStr=r"%g",
        saveName=r"N-DPL_%02dkeV.png"%E,)
...
def afterScript(P23_U32, plots, E):
    for plot in plots:
        ...
        with open('results_N-DPL.dat', 'a') as f:
...
if __name__ == '__main__':
    ...
    with open('results_N-DPL.dat', 'w') as f:
