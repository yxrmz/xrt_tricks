...
.. autoclass:: ParaboloidFlatLens(Plate)
   :members: __init__
.. autoclass:: FlatParaboloidLens(ParaboloidFlatLens)
...
__allSectioned__ = collections.OrderedDict([
    ...
    ('Refractive optics',
        ('ParaboloidFlatLens', 'FlatParaboloidLens', 'ParabolicCylinderFlatLens',
         'DoubleParaboloidLens', 'DoubleParabolicCylinderLens')),
...
class FlatParaboloidLens(ParaboloidFlatLens):
